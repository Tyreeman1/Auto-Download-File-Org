...
MAIN_CATEGORIES = {
    "Work": {
        "keywords": ["work", "project", "meeting", "client"],
        "subfolders": ["Documents", "Images", "Other"]  # Subfolders within Work
    },
    "Personal": {
        "keywords": ["personal", "family", "vacation"],
        "subfolders": ["Documents", "Images", "Videos", "Other"]
    },
    "Invoices": {
        "keywords": ["invoice", "receipt", "bill"],
        "subfolders": ["PDFs", "Images", "Other"]
    },
    "Screenshots": {
    ...
    "School": {
        "keywords": ["assignment", "homework", "lecture", "syllabus"],
        "subfolders": ["Documents", "PDFs", "Other"]
    },
}
...
if __name__ == "__main__":
    print("=== Automatic File Organizer with Subfolders ===\n")
    start_monitoring()